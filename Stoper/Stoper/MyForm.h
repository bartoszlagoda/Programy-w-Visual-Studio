...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Location = System::Drawing::Point(102, 223);
			...
			this->label1->Location = System::Drawing::Point(69, 165);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(117, 41);
			...
			this->ClientSize = System::Drawing::Size(277, 303);
...
#pragma endregion
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
		/// Funkcjonalnoœæ timera
		/// zwiêkszanie iloœci sekund o 1 (w interwale co 1000 ms)
		Sekundy++;
		...
		if (Sekundy >= 10 && Minuty <= 9)
		{
			label1->Text = "0" + Minuty + " : " + Sekundy;
		}
		 else if (Sekundy <= 9 && Minuty <= 9)
		{
